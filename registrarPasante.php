...
<form class="formNuevoPasante" name="f1" id="form2" action="registrarDatosPasante.php?idAlumno=<?php echo $id_Pasante ?>" method="post" enctype="multipart/form-data">
				...
				<legend>Datos Personales</legend>
					<table align="center" width="100%">
						...
						<tr width="100%">
							...
							<td colspan="5">
								<input id="nrodni" name="nrodni" type="text" class="campoText" onkeyup="maskDni()" onfocus="this.value = '';" pattern="[0-9]{2}+[.]{1}[0-9]{3}+[.]{1}[0-9]{3}" value="<?php echo $nrodni; ?>" maxlength="10" required/>
							</td>
						</tr>
						<tr width="100%">
							<td colspan="1" align="right">
