	...
	<table id="tablaCalif" align="center" width="100%" border="0">
		...
		<tr>
			<?php
				...
				while ($rowIdeaXProfe = pg_fetch_array($sql)){
					echo '<td class="contactar"><a href="sendToProfe.php?vernotas=1&idea='.$idIdea.'&idProfesor='.$rowIdeaXProfe['id'].'"><img class="msj" src="img/msj.png" title="Click aqu&iacute; para enviar un mail al profesor '.$rowIdeaXProfe['nombre'].'"><l3>  Contactar</l3></a></td>';
				}
			?>
		</tr>
		</tbody>
